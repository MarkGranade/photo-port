...
const PhotoList = ({ category }) => {
	...
	// Go through each "photo" in the [photos] array, trying to find every photo that matches the "category" that was selected by the user.
			...
			<div className="flex-row">
				{currentPhotos.map((image, i) => (
					<img
						...
						// The "key" attribute value must be a unique string
						key={image.name}
					/>
				))}
			</div>
